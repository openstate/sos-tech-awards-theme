  ...
  <div class="container">
    ...
    <div class="row bg-white">
      ...
      <div class="col-12 col-lg-4 text-center">
        ...
        <a href="https://www.cbs.nl/" target="_blank" rel="noopener">
          <img class="img-fluid" src="@asset('images/logo-cbs.svg')" alt="Centraal Bureau voor de Statistiek logo">
        </a>
      </div>
    </div>
    ...
    <div class="row bg-donkerblauw icons">
      <div class="col-12 text-right">
        ...
        &nbsp;
        &nbsp;
        <a href="https://github.com/openstate" target="_blank" rel="noopener">
